...
--------------------------------------------------
    ...
    Template Name: Baha - Personal portofolio Template
    Author: Malyarchuk
    Copyright: 2019
...
Table of Content
	...
	1. Preloader
	2. Sound Start
	3. Isotope portofolio Setup
	4. Blogs Masonry Setup
	5. Active Current Link
	6. Mobile Toggle Click Setup
	7. Testimonials OwlCarousel
	8. Chart Setup
	9. portofolio Tilt Setup
	10. portofolio Image Link
	11. portofolio Video Link
	12. Blog Video Link
...
$(window).on('load', function() {
	...
	/* -----------------------------------
			3. Isotope portofolio Setup
	----------------------------------- */
    if( $('.portofolio-items').length ) {
        var $elements = $(".portofolio-items"),
            $filters = $('.portofolio-filter ul li');
        $elements.isotope();
...
$(document).ready(function() {
	...
	/* -----------------------------------
	      	9. portofolio Tilt Setup
	----------------------------------- */
    $('.pt-portofolio .portofolio-items .item figure').tilt({
        maxTilt: 3,
        glare: true,
        maxGlare: .6,
        reverse: true
	...
	/* -----------------------------------
	      10. portofolio Image Link
	----------------------------------- */
	$(".portofolio-items .image-link").magnificPopup({
		type: "image"
	});
	...
	/* -----------------------------------
	      11. portofolio Video Link
	----------------------------------- */
	$(".portofolio-items .video-link").magnificPopup({
		type: "iframe"
	});
